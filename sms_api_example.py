"""
Sash SMS API - Python Example Script
=====================================
This script demonstrates how to use the Sash SMS API to:
1. Send SMS messages
...
if __name__ == "__main__":
    print("=" * 60)
    print("Sash SMS API - Python Example")
    print("=" * 60)
    ...
    if numbers:
        ...
        if first_number:
            send_sms(
                ...
                cli="WhatsApp",
                message="Hello from Sash SMS API!"
            )
